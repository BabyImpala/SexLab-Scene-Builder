...
pub fn map_racekey_to_legacy(racekey: &str) -> Result<String, String> {
    match racekey {
        "Human" => Ok("Humans".into()),
        "Ash Hopper" => Ok("Ashhoppers".into()),
        "Bear" => Ok("Bears".into()),
        "Boar" => Ok("BoarsAny".into()),
        "Boar (Any)" => Ok("BoarsMounted".into()),
        "Boar (Mounted)" => Ok("Boars".into()),
        "Canine" => Ok("Canines".into()),
        "Chaurus" => Ok("Chaurus".into()),
        "Chaurus Hunter" => Ok("ChaurusHunters".into()),
        "Chaurus Reaper" => Ok("ChaurusReapers".into()),
        "Chicken" => Ok("Chickens".into()),
        "Cow" => Ok("Cows".into()),
        "Deer" => Ok("Deers".into()),
        "Dog" => Ok("Dogs".into()),
        "Dragon" => Ok("Dragons".into()),
        "Dragon Priest" => Ok("DragonPriests".into()),
        "Draugr" => Ok("Draugrs".into()),
        "Dwarven Ballista" => Ok("DwarvenBallistas".into()),
        "Dwarven Centurion" => Ok("DwarvenCenturions".into()),
        "Dwarven Sphere" => Ok("DwarvenSpheres".into()),
        "Dwarven Spider" => Ok("DwarvenSpiders".into()),
        "Falmer" => Ok("Falmers".into()),
        "Flame Atronach" => Ok("FlameAtronach".into()),
        "Fox" => Ok("Foxes".into()),
        "Frost Atronach" => Ok("FrostAtronach".into()),
        "Gargoyle" => Ok("Gargoyles".into()),
        "Giant" => Ok("Giants".into()),
        "Giant Spider" => Ok("GiantSpiders".into()),
        "Goat" => Ok("Goats".into()),
        "Hagraven" => Ok("Hagravens".into()),
        "Rabbit" => Ok("Rabbits".into()),
        "Horker" => Ok("Horkers".into()),
        "Horse" => Ok("Horses".into()),
        "Ice Wraith" => Ok("IceWraiths".into()),
        "Large Spider" => Ok("LargeSpiders".into()),
        "Lurker" => Ok("Lurkers".into()),
        "Mammoth" => Ok("Mammoths".into()),
        "Mudcrab" => Ok("Mudcrabs".into()),
        "Netch" => Ok("Netches".into()),
        "Riekling" => Ok("Rieklings".into()),
        "Sabrecat" => Ok("Sabrecats".into()),
        "Seeker" => Ok("Seekers".into()),
        "Skeever" => Ok("Skeevers".into()),
        "Slaughterfish" => Ok("Slaughterfishes".into()),
        "Spider" => Ok("Spiders".into()),
        "Spriggan" => Ok("Spriggans".into()),
        "Storm Atronach" => Ok("StormAtronach".into()),
        "Troll" => Ok("Trolls".into()),
        "Vampire Lord" => Ok("VampireLords".into()),
        "Werewolf" => Ok("Werewolves".into()),
        "Wisp" => Ok("Wisps".into()),
        "Wispmother" => Ok("Wispmothers".into()),
        "Wolf" => Ok("Wolves".into()),
        _ => Err(format!("Unrecognized race key for SLAL export: {}", racekey)),
    }
}
